      ...
      <div class="col-md-8">
        <div class="container">
          ...
          <div class="row mt-2 ">
            ...
            <div class="container mt-4 wow bounceInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
              <div class="row">
                <div class="col-md-4 bgc mb-4 ">
                  <div class="card mb-4 box-shadow  mt-4">
                    ...
                    <div class="card-body">
                      <a href="#">测试图文</a>
                      <div class="body-cont">
                        <span>个人博客模板，宽屏响应式个人博客模板，采用冷色系为主...</span>
                      </div>
                ...
                <div class="col-md-4 bgc mb-4">
                  <div class="card mb-4 box-shadow mt-4">
                    <div class="showimg showtitle">
                      <img class="card-img-top"  style=" width: 100%; display: block;" src="images/2.png" data-holder-rendered="true">
                    </div>
                    <div class="card-body">
                      <a href="#">测试图文</a>
                      <div class="body-cont">
                ...
                <div class="col-md-4 bgc mb-4 ">
                  <div class="card mb-4 box-shadow  mt-4">
                    <div class="showimg">
                      <img class="card-img-top"  style=" width: 100%; display: block;" src="images/10.jpg" data-holder-rendered="true">
                    </div>
                ...
                <div class="col-md-4 bgc mb-4">
                  <div class="card mb-4 box-shadow mt-4">
                    <div class="showimg showtitle">
                      <img class="card-img-top"  style=" width: 100%; display: block;" src="images/11.png" data-holder-rendered="true">
                    </div>
                    <div class="card-body">
                      <a href="#">测试图文</a>
                      <div class="body-cont">
                ...
                <div class="col-md-4 bgc mb-4">
                  <div class="card  box-shadow mt-4">
                    <div class="showimg">
                      <img class="card-img-top"  style=" width: 100%; display: block;" src="images/12.png" data-holder-rendered="true">
                    </div>
                    <div class="card-body">
                      <a href="#">测试图文</a>
                      <div class="body-cont">
